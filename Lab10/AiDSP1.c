...
//
// Created on:	09.12.2013 at 17:47:42 by Terran.
...
int main (int argc, char *argv[])
{
	...
	errChk (mainPanel = LoadPanel (0, "AiDSP1.uir", MAIN_PANEL));
...
{	 
	...
	double filteredSignal[nSamples];
	...
	double frequencyArray[numRead];
	double ps[numRead];
	double WfR[numRead];
	double WfI[numRead];
	
	ComputePowerSpectrum2(rawSignal, numRead, samplingRate, frequencyArray, ps, WfR, WfI);
		//sterg graph-ul unde urmeaza sa plotez spectrul semnalului
	DeleteGraphPlot (mainPanel, MAIN_PANEL_IDC_OUTGRAPH_SPECTRUM, -1, VAL_IMMEDIATE_DRAW);	
		//plotez spectrul semnalului
	PlotXY (mainPanel, MAIN_PANEL_IDC_OUTGRAPH_SPECTRUM, frequencyArray, ps, nSamples/2, VAL_DOUBLE, VAL_DOUBLE, VAL_THIN_LINE, VAL_EMPTY_SQUARE, VAL_SOLID,1, VAL_GREEN);
	PlotXY (mainPanel, MAIN_PANEL_IDC_OUTGRAPH_SPECTRUM, frequencyArray, WfR, nSamples/2, VAL_DOUBLE, VAL_DOUBLE, VAL_THIN_LINE, VAL_EMPTY_SQUARE, VAL_SOLID,1, VAL_GREEN);
	PlotXY (mainPanel, MAIN_PANEL_IDC_OUTGRAPH_SPECTRUM, frequencyArray, WfI, nSamples/2, VAL_DOUBLE, VAL_DOUBLE, VAL_THIN_LINE, VAL_EMPTY_SQUARE, VAL_SOLID,1, VAL_GREEN);
